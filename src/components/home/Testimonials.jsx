      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white tracking-tight">
            What Travelers <span className="text-emerald-600 dark:text-emerald-400">Say</span>
          </h2>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative bg-gray-50 dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 p-8 md:p-12 lg:p-14">
            {/* Quote icon */}
            ...
            <div className="flex items-center gap-1 mb-6">
              ...
              <span className="text-sm text-gray-400 dark:text-gray-500 ml-2 font-medium">{t.rating}.0</span>
            </div>
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              ...
              >
                <img
                  src={t.avatar}
                  alt={t.name}
                  className="w-14 h-14 rounded-2xl object-cover ring-2 ring-emerald-100 dark:ring-emerald-900/50"
                />
                <div>
              ...
              <div className="flex items-center gap-3">
                <button
                  onClick={prev}
                  className="w-11 h-11 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 flex items-center justify-center hover:bg-emerald-50 dark:hover:bg-emerald-900/40 hover:border-emerald-200 dark:hover:border-emerald-700 transition-all active:scale-95"
                >
